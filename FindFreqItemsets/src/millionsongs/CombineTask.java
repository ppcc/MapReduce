...
/**
 * This is a MapReduce job aiming to emit transaction (User, song1, song2, song3
 * ... songn). Song ids are in asc order. <br>
 * Created by peilicao on 11/9/14.
 */
public class CombineTask {
	/**
	 * This mapper will read the triplet file and emits (user,song) as output
	 * key, output value is null
	 * 
	 * @author peilicao
	 *
	 */
	public static class MyMapper extends
			Mapper<Object, Text, TupleKey, NullWritable> {
		...
		public void map(Object key, Text value, Context context)
			...
			/**
			 * Convert userid and songid to integer for easier ordered by
			 * reducer
			 */
	...
	/**
	 * This reducer will read ((user,song),null) emitted by mapper and outputs
	 * transactions (User, song1, song2, song3 ... songn). The order of input
	 * key is first ordered by userid asc, then for same userid, ordered by
	 * songid asc. By doing this, we make sure that the output of reducer is in
	 * order in each line.
	 * 
	 * @author peilicao
	 *
	...
	public static class MyReducer extends
			Reducer<TupleKey, NullWritable, NullWritable, Text> {
		private static final NullWritable nullKey = NullWritable.get();
		private Text out = new Text();
		private StringBuilder builder = new StringBuilder();

		@Override
		public void reduce(TupleKey key, Iterable<NullWritable> values,
	 ...
	 *
	 */
	public static class CustomizePartitioner extends
			Partitioner<TupleKey, NullWritable> {

		@Override
		public int getPartition(TupleKey tupleKey, NullWritable intWritable,
				int numPartitioner) {
